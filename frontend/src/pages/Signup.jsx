  ...
  return (
    <div className="grid min-h-screen place-items-center px-5 text-ink dark:text-white">
      <form onSubmit={submit} className="glass w-full max-w-md rounded-[32px] p-6">
        ...
        <p className="mt-5 text-center text-sm text-slate-600 dark:text-slate-300">Already registered? <Link className="font-bold text-indigo dark:text-indigo-200" to="/login">Login</Link></p>
      </form>
    </div>
  );
}
